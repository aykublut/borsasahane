...
const Features = () => {
  ...
  return (
    <div
      ...
      id="features"
    >
      <div className="bg-black/40 scroll-offset h-full  w-full absolute top-0 left-0 flex flex-col justify-center items-center text-center text-white/80 md:gap-10 gap-1">
